...
/* ==================== methods =====================*/
RW.methods.getObjectGroup = function(name){
...
RW.methods.animations = function(obj, name, frames, frameRate=1, loop=false){
    /*
    * 添加动画, 并播放.
    * group: 可以是组,也可以是精灵
    * frames: 从0开始?
...
RW.methods.setPlaySite = function(playerGroup, x, y){
...
RW.methods.getPlayerSite = function(playerObj, index=0){
...
RW.methods.getPlayerDirection = function(playerObj) {
    /* 玩家方向, */
...
RW.update.listenKey.playerMove = function(playerG, role, resolve, resolveContext, reject, rejectContext, that=RW.DeveloperModel) {
